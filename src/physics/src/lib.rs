...
//     // #[wasm_bindgen(method)]
//     // pub fn time_step(&mut self, dt: f64) {
//     //     let universe = unsafe { &mut *self.universe };
//     //     universe.time_step(dt);
//     // }
//     // pub fn add_planet(&mut self, planet: JsValue) {
//     //     let universe = unsafe { &mut *self.universe };
//     //     universe.planets.push(Planet::new(Vec2::new(planet.pos[0], planet.pos[1]), Vec2::new(planet.vel[0], planet.vel[1]), planet.radius, planet.mass, planet.color))
//     // }
// }
