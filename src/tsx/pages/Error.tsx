    ...
    <Transitions>
      <Stage width={width} height={height} options={{ backgroundColor: 0x000 }} className="canvas">
        ...
        <div className="fixed -translate-x-1/2 -translate-y-1/3 left-1/2 top-1/3">
          ...
          <Link to='/' className="no-underline bg-black text-neutral-200 text-3xl lg:text-6xl font-extrabold shadow-black transition-all duration-[1250ms] ease-[cubic-bezier(0.19,1,0.22,1)] px-32 py-2.5 border-0 border-solid hover:border hover:shadow-[inset_0_0_20px_rgba(255,255,255,0.5),0_0_20px_rgba(255,255,255,0.2)] hover:border-solid outline">Home</Link>
        </div>
    </Transitions>
  )
}